...
//Directories
_void = "",
_urlIndex = "https://" + window.location.hostname,
_urlParamEquals = '=',
_urlParamHyphen = '-',
_urlParamBegin = '?',
_urlParamAdd = '&',
...
function showGridProducts(product, language, sectionClass)
{
    ...
    pic.attr("src", "http://" + window.location.hostname + product.link);
...
function showProduct(product, language, sectionClass)
{
    ...
    pic = $("<img>");
    pic.attr("class", "image");
    pic.attr("src", "http://" + window.location.hostname + product.source);
    pic.attr("alt", name);
...
function createCatUrl(category, slug)
{
    ...
    {
        case _camisetas:
            url = _urlIndex + _urlSlash + _merchandisingName + _urlSlash + _camisetasName + _urlSlash  + "producto" + 
                    _urlSlash + slug;
        break;
        
        case _sudaderas:
            url = _urlIndex + _urlSlash + _merchandisingName + _urlSlash + _sudaderasName + _urlSlash  +"producto"+ 
            _urlSlash + slug;
        break;
        
        case _marscarillas:
            url = _urlIndex + _urlSlash + _merchandisingName + _urlSlash + _marscarillasName + _urlSlash  +"producto"+ 
            _urlSlash + slug;
        break;
        case _bolsas:
            url = _urlIndex + _urlSlash +  _merchandisingName + _urlSlash + _bolsasName + _urlSlash  +"producto"+ 
            _urlSlash + slug;
        break;
        
        case _sweters:
            url = _urlIndex + _urlSlash +  _merchandisingName + _urlSlash + _swetersName  +"producto"+ 
            _urlSlash + slug;
        break;

        case _posters:
            url = _urlIndex + _urlSlash +  _merchandisingName + _urlSlash + _postersName  +"producto"+ 
            _urlSlash + slug;
        break;
        
        case _cuadros:
            url = _urlIndex + _urlSlash +  _merchandisingName + _urlSlash + _cuadrosName  +"producto"+ 
            _urlSlash + slug;
        break;
